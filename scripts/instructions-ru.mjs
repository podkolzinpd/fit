...
export const INSTRUCTIONS_RU = {
  ...
  // === Икры ===
  'fedb-barbell-seated-calf-raise': [
  ...
  'fedb-dumbbell-seated-one-leg-calf-raise': [
  ...
  'fedb-barbell-curl': [
    'Встаньте, штанга в опущенных руках хватом на ширине плеч снизу.',
    'Согните руки, поднимая штангу к плечам, локти прижаты к корпусу.',
    'Подконтрольно опустите штангу, полностью разгибая руки.',
  ],
  'fedb-barbell-curls-lying-against-an-incline': [
  ...
  'fedb-cable-hammer-curls-rope-attachment': [
  ...
  'fedb-close-grip-ez-bar-curl-with-band': [
  ...
  'fedb-palms-down-dumbbell-wrist-curl-over-a-bench': [
  ...
  'fedb-palms-down-wrist-curl-over-a-bench': [
  ...
  'fedb-palms-up-barbell-wrist-curl-over-a-bench': [
  ...
  'fedb-palms-up-dumbbell-wrist-curl-over-a-bench': [
  ...
  'fedb-kettlebell-one-legged-deadlift': [
  ...
  'fedb-barbell-shrug-behind-the-back': [
  ...
  'fedb-calf-machine-shoulder-shrug': [
  ...
  'fedb-chin-up': [
    ...
    'Подтянитесь, сводя лопатки, до подбородка над перекладиной.',
    'Медленно опуститесь до полного выпрямления рук.',
  ],
  'fedb-pullups': [
    'Возьмитесь за перекладину прямым широким хватом.',
    'Подтянитесь, сводя лопатки, грудью к перекладине.',
    'Подконтрольно опуститесь до прямых рук.',
  ],
  ...
  'fedb-lying-cambered-barbell-row': [
  ...
  'fedb-seated-cable-rows': [
    'Сядьте у нижнего блока, стопы в упоре, спина прямая, рукоять в руках.',
    'Подтяните рукоять к животу, сводя лопатки, локти вдоль корпуса.',
    'Подконтрольно верните, растягивая спину, не круглите поясницу.',
  ],
  'fedb-smith-machine-bent-over-row': [
