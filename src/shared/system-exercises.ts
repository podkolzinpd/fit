...
export const SYSTEM_EXERCISES = [
  ...
  { source: 'system', ref: 'plank', name: 'Планка', muscleGroup: 'core', inputKind: 'strength' },
  ...
  { source: 'system', ref: 'side-plank', name: 'Боковая планка', muscleGroup: 'core', inputKind: 'strength' },
