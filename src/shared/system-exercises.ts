...
const FUNCTIONAL_PROTOCOLS = [
  { source: 'system', ref: 'interval-bike', name: 'Интервалы на велотренажёре', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Велотренажёр', primaryMuscleDetail: 'Кардио', instructions: ['Укажите время и дистанцию одного интервала.'] },
  { source: 'system', ref: 'interval-rowing', name: 'Интервалы на гребном тренажёре', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Гребной тренажёр', primaryMuscleDetail: 'Кардио', instructions: ['Укажите время и дистанцию одного интервала.'] },
  { source: 'system', ref: 'interval-walking', name: 'Интервальная ходьба', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Беговая дорожка', primaryMuscleDetail: 'Кардио', instructions: ['Укажите время и дистанцию одного интервала.'] },
  { source: 'system', ref: 'tabata', name: 'Табата', muscleGroup: 'cardio', inputKind: 'reps', equipment: 'Без оборудования', primaryMuscleDetail: 'Кардио', instructions: ['Укажите время рабочего отрезка и число повторов. Отдых и движение добавьте в комментарий к упражнению.'] },
  { source: 'system', ref: 'emom', name: 'EMOM', muscleGroup: 'cardio', inputKind: 'reps', equipment: 'Без оборудования', primaryMuscleDetail: 'Кардио', instructions: ['Один подход — одна минута: укажите рабочее время и повторы.'] },
  { source: 'system', ref: 'amrap', name: 'AMRAP', muscleGroup: 'cardio', inputKind: 'reps', equipment: 'Без оборудования', primaryMuscleDetail: 'Кардио', instructions: ['Укажите лимит времени и число выполненных повторов или раундов.'] },
  { source: 'system', ref: 'circuit-training', name: 'Круговая тренировка', muscleGroup: 'cardio', inputKind: 'reps', equipment: 'Без оборудования', primaryMuscleDetail: 'Кардио', instructions: ['Укажите время круга и число повторов или раундов. Состав круга добавьте в комментарий.'] },
  { source: 'system', ref: 'farmer-carry', name: 'Фермерская прогулка', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Гантели или гири', primaryMuscleDetail: 'Кардио', instructions: ['Укажите длительность и дистанцию проходки.'] },
  { source: 'system', ref: 'sled-push', name: 'Толкание саней', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Сани', primaryMuscleDetail: 'Кардио', instructions: ['Укажите длительность и дистанцию проходки.'] },
] as const satisfies readonly ExerciseSnapshot[]
...
const RUNNING_DRILLS = [
  { source: 'system', ref: 'running-high-knees', name: 'Бег с высоким подниманием бедра', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Без оборудования', primaryMuscleDetail: 'Беговые упражнения', instructions: ['Держите корпус ровно и поднимайте бедро до комфортной высоты. Укажите время и дистанцию отрезка.'] },
  { source: 'system', ref: 'running-butt-kicks', name: 'Бег с захлёстом голени', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Без оборудования', primaryMuscleDetail: 'Беговые упражнения', instructions: ['Бегите легко, направляя пятку к ягодице без запрокидывания корпуса. Укажите время и дистанцию.'] },
  { source: 'system', ref: 'running-ankling', name: 'Семенящий бег', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Без оборудования', primaryMuscleDetail: 'Беговые упражнения', instructions: ['Делайте короткие частые шаги с активной работой стопы. Укажите время и дистанцию.'] },
  { source: 'system', ref: 'running-bounds', name: 'Беговые прыжки', muscleGroup: 'cardio', inputKind: 'distance', equipment: 'Без оборудования', primaryMuscleDetail: 'Беговые упражнения', instructions: ['Продвигайтесь вперёд упругими прыжками с контролируемым приземлением. Укажите время и дистанцию.'] },
] as const satisfies readonly ExerciseSnapshot[]
...
const WARMUP_AND_MOBILITY = [
  { source: 'system', ref: 'joint-warmup', name: 'Суставная разминка', muscleGroup: 'other', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Разминка', instructions: ['Выполните мягкие круговые движения основными суставами без боли. Укажите общее время.'] },
  { source: 'system', ref: 'shoulder-mobility', name: 'Мобилизация плеч', muscleGroup: 'shoulders', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Плечи', instructions: ['Выполните контролируемые движения плечами в комфортной амплитуде. Укажите время работы.'] },
  { source: 'system', ref: 'band-external-rotation', name: 'Внешняя ротация плеча с резинкой', muscleGroup: 'shoulders', inputKind: 'duration', equipment: 'Резина', primaryMuscleDetail: 'Плечи', instructions: ['Держите локоть у корпуса и плавно поверните предплечье наружу. Укажите время работы.'] },
  { source: 'system', ref: 'thoracic-mobility', name: 'Мобилизация грудного отдела', muscleGroup: 'core', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Пресс', instructions: ['Выполняйте мягкие повороты и разгибание грудного отдела, не форсируя амплитуду. Укажите время.'] },
  { source: 'system', ref: 'hip-mobility', name: 'Мобилизация тазобедренных суставов', muscleGroup: 'legs', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Передняя поверхность бедра', instructions: ['Выполняйте контролируемые круговые движения и раскрытие таза. Укажите время работы.'] },
  { source: 'system', ref: 'ankle-mobility', name: 'Мобилизация голеностопа', muscleGroup: 'legs', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Икроножные', instructions: ['Плавно переносите колено над стопой, сохраняя пятку на полу. Укажите время работы.'] },
  { source: 'system', ref: 'dynamic-hamstring-stretch', name: 'Динамическая растяжка задней поверхности бедра', muscleGroup: 'legs', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Задняя поверхность бедра', instructions: ['Двигайтесь плавно в комфортной амплитуде, без пружинящих рывков. Укажите время работы.'] },
  { source: 'system', ref: 'cat-cow', name: 'Кошка-корова', muscleGroup: 'core', inputKind: 'duration', equipment: 'Без оборудования', primaryMuscleDetail: 'Пресс', instructions: ['На четвереньках плавно чередуйте округление и прогиб спины. Укажите время работы.'] },
] as const satisfies readonly ExerciseSnapshot[]
