...
export function MyProgressPage() {
  ...
  return <Page className="client-progress-page" title="Мой прогресс" back="/me"><AsyncView loading={mine.isLoading || entries.isLoading || metrics.isLoading} error={mine.error ?? entries.error ?? metrics.error} onRetry={() => { void mine.refetch(); void entries.refetch(); void metrics.refetch() }}>
