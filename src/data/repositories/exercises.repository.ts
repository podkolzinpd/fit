...
export const exercisesRepository = {
  ...
  async parseWorkout(text: string, catalog: readonly ExerciseSnapshot[]): Promise<WorkoutParseResponse> {
    const result = await exerciseQueries.parseWorkout(text, catalog)
