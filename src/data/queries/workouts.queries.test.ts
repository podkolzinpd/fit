...
describe('workoutQueries lists', () => {
  ...
  it('passes workout mutations through their RPC contracts', () => {
    ...
    workoutQueries.finish('workout-id', 10)
    workoutQueries.remove('workout-id', 11)
    ...
    expect(rpc).toHaveBeenNthCalledWith(9, 'finish_workout', { p_workout_id: 'workout-id', p_expected_version: 10 })
    expect(rpc).toHaveBeenNthCalledWith(10, 'soft_delete_workout', { p_workout_id: 'workout-id', p_expected_version: 11 })
  })
})
