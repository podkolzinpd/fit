...
describe('workoutQueries lists', () => {
  ...
  it('passes workout mutations through their RPC contracts', () => {
    ...
    workoutQueries.finish('workout-id', 12)
    workoutQueries.remove('workout-id', 13)
    ...
    expect(rpc).toHaveBeenNthCalledWith(12, 'finish_workout', { p_workout_id: 'workout-id', p_expected_version: 12 })
    expect(rpc).toHaveBeenNthCalledWith(13, 'soft_delete_workout', { p_workout_id: 'workout-id', p_expected_version: 13 })
  })
})
