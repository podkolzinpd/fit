// schema-sha256: e814d0f6d2fb19ec60c43f70dc94a1dd3655bd50c3af7c27814d518cb99d39d9
...
type WorkoutExerciseRow = { id: string; workout_id: string; trainer_id: string; client_id: string; position: number; exercise_source: string; exercise_ref: string; custom_exercise_id: string | null; exercise_name: string; muscle_group: string; input_kind: string; block_id: string; block_type: string; block_rounds: number; trainer_comment: string | null; created_at: string; updated_at: string }
...
type WorkoutListExerciseRow = Pick<WorkoutExerciseRow, 'id' | 'position' | 'exercise_source' | 'exercise_ref' | 'custom_exercise_id' | 'exercise_name' | 'muscle_group' | 'input_kind' | 'block_id' | 'block_type' | 'block_rounds' | 'trainer_comment'> & { sets: WorkoutListSetRow[] }
