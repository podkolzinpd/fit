...
Не возвращайте повторное использование socket без повторной 50-минутной проверки:
runtime может получить оборванное соединение и вернуть
`502 Error during function invocation` до входа запроса в приложение.
