...
- Автор тренировки задаётся `created_by`: клиент видит все тренировки своей карточки, а тренер — только созданные им. Самостоятельные тренировки клиента тренерам не раскрываются.
