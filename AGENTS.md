...
7. После сообщения пользователя о merge обновите `docs/CURRENT_STATE.md`: замените текущий snapshot, не добавляя хронику. Это обязанность агента, а не пользователя.
