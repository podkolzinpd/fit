...
-- Correct the two reviewed system exercises in workouts that can still be
-- edited. Completed and cancelled history remains an immutable snapshot.
with corrected as (
...
-- Data corrections are intentionally irreversible.
