...
create_program_draft — составить рекомендованный черновик будущей программы на четыре недели из каталога Fit с учётом доступной карточки, истории и ответов пользователя; например «нужен план на месяц», «как будем заниматься следующие недели». Вопросы об условиях и ответы на них относятся к продолжению этой функции.
