...
Сначала спроектируй программу как специалист по безопасному планированию нагрузки, затем заполни назначения. Не начинай со случайного списка упражнений.
...
export const QUALITY_REVIEW_NOTES: Record<string, string> = {
  lower_body_only_knee_dominant: 'Нужно проверить: работа ног сосредоточена на вариантах приседа без тазобедренного движения или сгибания колена. Оцените, оправдан ли этот выбор целью и ограничениями.',
