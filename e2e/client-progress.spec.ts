...
test('trainer reviews the client copy separately from internal attention items', async ({ page }) => {
  ...
  await expect(overview.getByText(/Заметный прогресс в силовых упражнениях и беге/)).toBeVisible()
  await expect(overview.getByText(/Проверить: причина максимального перерыва/)).toBeVisible()
