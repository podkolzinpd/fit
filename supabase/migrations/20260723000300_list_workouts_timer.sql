-- Surface the timer timestamps (started_at / completed_at) from list_workouts so
-- the history list can show total workout duration without a per-row detail fetch.
