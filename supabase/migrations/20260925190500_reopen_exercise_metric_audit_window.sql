-- A second owner-run workout backfill follows after the source gate was
-- restored for the Schedule V2 migration. Keep product writes paused, but let
-- only the PostgreSQL migration owner pass statement triggers for a short,
