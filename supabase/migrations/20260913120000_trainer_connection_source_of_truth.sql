...
revoke all on function public.is_active_client_trainer_connection(uuid,uuid)
  from public,anon,authenticated;
revoke all on function public.list_client_trainers(uuid), public.open_chat(uuid,uuid),
  public.list_chat_threads(), public.get_chat_connection_state(uuid),
  public.send_chat_connection_invitation(uuid) from public,anon;
grant execute on function public.list_client_trainers(uuid), public.open_chat(uuid,uuid),
  public.list_chat_threads(), public.get_chat_connection_state(uuid),
  public.send_chat_connection_invitation(uuid) to authenticated;
