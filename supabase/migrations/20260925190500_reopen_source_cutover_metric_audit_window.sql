-- The catalog-wide metric audit backfill runs next. Product writes remain
-- paused; only the PostgreSQL migration owner may cross the gate, and only
-- during this short self-expiring window.
