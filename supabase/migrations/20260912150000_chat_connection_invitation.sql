...
revoke all on function public.get_chat_connection_state(uuid),
  public.send_chat_connection_invitation(uuid), public.accept_chat_connection_invitation(uuid) from public, anon;
grant execute on function public.get_chat_connection_state(uuid),
  public.send_chat_connection_invitation(uuid), public.accept_chat_connection_invitation(uuid) to authenticated;
