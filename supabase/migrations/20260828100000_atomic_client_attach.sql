...
revoke all on function app_private.client_dependency_counts(uuid) from public, anon, authenticated;
...
alter table public.client_training_summaries
  alter constraint client_training_summaries_client_fk deferrable initially immediate;
alter table public.client_published_training_summaries
  alter constraint published_training_summaries_client_fk deferrable initially immediate,
