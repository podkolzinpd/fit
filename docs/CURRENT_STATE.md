...
Проверенный `main`: `293a3bb` (`YAFIT-288: превратить историю тренировок в спортивную хронику (#390)`)

## Активная работа

- Активная продуктовая задача: `YAFIT-294` — сделать мобильные Progress и
  редактор визуально понятными: русские названия рекордов, ясная регулярность и
  нижняя навигация без серого перекрытия.
...
1. `YAFIT-294` — ясность мобильных Progress и редактора.
