...
Обновлено: 2026-09-03. Проверенный базовый `main`: `0576d8b` (`Today voice choice same row, #769`).
...
- Tenant tooling: encrypted 28-table manifest; export/import/validation прошли на двух Podman PostgreSQL; `000029–000030` сохраняют parity, удалённые БД не менялись.
## Ближайший порядок
