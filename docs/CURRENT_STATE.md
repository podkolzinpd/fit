...
Обновлено: 2026-09-09. База: `main` `8827d4ee` (#841). Активно: содержательный ИИ-анализ Progress. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
