...
4. В продуктовом бэклоге `YAFIT-333` отложена: список клиентов не должен
   дублировать очередь действий на главной тренера. `YAFIT-334` и `YAFIT-335`
   рассматриваются отдельно и не начинаются без согласования. Аналитика
   основного цикла остаётся в конце программы.
