...
Обновлено: 2026-09-09. База: `main` `b86b097`. Активно: YAFIT-487, стабильный переход к ИИ-анализу в Client Progress. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
