...
Обновлено: 2026-09-03. Проверенный базовый `main`: `00ee030`; активный PR #772 исправляет создание своего упражнения клиентом (#771).
...
- #772: автор custom exercise отделён от владельца раздела; самостоятельный и связанный клиент создают упражнение и сохраняют тренировку. ID/история тренеров сохранены; app check, SQL/RLS и mobile E2E проверены локально; production — после merge и Deploy database.
## Ближайший порядок
