...
Обновлено: 2026-09-05. База: `main` `03e80cba`. Активно: восстановление stage deployment перед удалённой репетицией переноса tenant. В `main` завершена YAFIT-467: 83 упражнения исключены из новых выборов; история и 4 использовавшихся сохранены.
