...
## Ближайший порядок
1. YAFIT-480–482 выпущены. Проверить обязательный CI YAFIT-483 и выполнить штатный merge.
2. Проверить production и свежий iOS из подтверждённого main после YAFIT-483.
3. YAFIT-483 реализован: центр результатов и недельные подходы; check 1305/364/112 passed, мобильная приёмка и выпуск впереди.
4. Итоговая проверка production и свежего iOS; пользовательский пилот после выпуска.
