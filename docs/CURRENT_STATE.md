...
Проверенный базовый `main`: `b11b2c5` (`YAFIT-320: автоматизировать доставку AI-сводки (#477)`)
...
- Отдельная серия улучшений Progress идёт по согласованному плану. `#474`
  ...
  ключи безопасным отображением, а `#477` автоматизировал безопасную доставку
  функции через GitHub Actions без Docker. Текущий отдельный блок переносит
  измеримые сравнения в проверяемые серверные факты; полный план сохранён в
