...
Проверенный `main`: `94577f3` (`YAFIT-223: стабилизировать realtime Trainer ↔ Client (#383)`)

## Активная работа

- Активная продуктовая задача: `YAFIT-242` — единый timezone contract для
  Today, недель, расписания и переходов DST.
- Следующая задача roadmap: `YAFIT-259` — conflicts и slow network в live,
  локальными стабилизирующими изменениями без redesign.
