...
Обновлено: 2026-09-09. База: `main` `3451d7e`. Активно: YAFIT-484, исправление переключателя карты тела на Client Home. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
...
- YAFIT-480 закрыт: #827 + #828 / 178094d. YAFIT-481 закрыт: #829 / 95e61ce. YAFIT-482 закрыт: #831 / 1f7366e. YAFIT-483 закрыт: #832 / 3451d7e; CI 34301316869, Vercel 6341134750, public auth и свежий iOS проверены.
...
## Ближайший порядок
1. YAFIT-480–483 выпущены. YAFIT-484 локально исправляет геометрию «Спереди / Сзади» только в компактной карте Client Home.
2. Переключатель получает равные сегменты и 44 px touch target; карта Progress, данные нагрузки и ИИ-контур не меняются.
3. Локально зелёные check 1305/364/112, Darwin/WebKit и Linux 390/430 light/dark visual, 360/375 overflow smoke и переключение обеих сторон.
