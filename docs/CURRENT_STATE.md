...
Проверенный базовый `main`: `9d5b20e` (`Пилот видео техники Vital Animations (#744)`)
...
- Каталог использует локальное зацикленное видео для четырёх упражнений пилота
  Vital Animations с точным совпадением движения. Видимые карточки каталога и
  крупная техника показывают ролик; при ошибке, отсутствии видео или включённом
  уменьшении движения сохраняется кадровый fallback.
