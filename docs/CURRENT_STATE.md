...
Обновлено: 2026-09-05. База: `main` `f005893c`. Активно: stage migrations актуальны; устраняется transient-сбой DeployRevision перед удалённой репетицией переноса tenant.
