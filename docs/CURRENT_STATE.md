...
Проверенный базовый `main`: `d93a3f0` (`YAFIT-321: показывать проверяемые факты прогресса (#478)`)
...
- Отдельная серия улучшений Progress идёт по согласованному плану. `#474`
  ...
  в проверяемые серверные факты. Текущий отдельный блок унифицирует визуальную
  иерархию анализа для тренера и клиента; полный план сохранён в
