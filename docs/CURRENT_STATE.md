...
- Расписание тренера использует компактную мобильную иерархию: месяц и
  календарь, единая неделя с понедельника, выбранная дата с однозначным числом
  тренировок и нейтральное действие «Запланировать». События показывают время,
  клиента, краткий состав и текстовый статус; шкала сразу фокусируется на
  ближайшей тренировке, первой завершившейся или текущем времени.
