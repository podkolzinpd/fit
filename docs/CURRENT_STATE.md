...
Обновлено: 2026-09-09. База: `main` `f1561b5`. Активно: компактные строки подходов Live после YAFIT-487. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
...
- Live сохраняет каждое изменение подхода на устройстве, автоматически досылает pending-черновики и ограничивает зависшие запросы. Finish сначала отправляет
  ...
  нажатия 44 px, обычная строка занимает 52–56 px, а план раскрывается по
  требованию без изменения сохранённых плановых данных.
