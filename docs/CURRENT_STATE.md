...
Обновлено: 2026-09-03. База задачи: `main` `7f04642` (#775, возвраты и календарь тренера). Активная задача: согласованный каталог, новые названия и синонимы; см. `docs/design/EXERCISE_CATALOG_CURATION.md`.
