...
## Активная цель
Каталог упражнений (#1193): скрыты 27 дополнительных дублей только из нового выбора; история и поиск по старым названиям сохранены. Добавлен фильтр совместимости похожего медиа и явный запрет трёх неверных пар из разбора скриншотов. Горизонтальный велотренажёр/семенящий бег не используют видео другого варианта. Полного визуального аудита каждого ролика нет; отсутствие точного видео остаётся ограничением. Локальные проверки пройдены, финальный CI и production-публикация ожидаются.
