...
Проверенный базовый `main`: `21bc434` (`Ассистент: сохранять диктовку при уточнении клиента (#617)`)

## Активное изменение

- Ассистент тренера сопоставляет русские имена клиентов в естественных
  падежных формах: «Анне Смирновой», «прогресс Анны Смирновой» и каноническая
  «Анна Смирнова» ведут к одной карточке. При совпадении нескольких клиентов
  ассистент по-прежнему просит выбрать человека явно.
