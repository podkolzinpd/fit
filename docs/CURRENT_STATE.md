...
Обновлено: 2026-09-10. База ветки: `main` `31fa3475` (#854). Активно: Client Progress переводится на ИИ-анализ всей тренировочной картины выбранного и предыдущего периодов. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
