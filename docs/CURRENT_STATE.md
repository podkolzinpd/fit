...
Обновлено: 2026-09-08. База: `main` `1b9c885d`. Активно: закрыть multi-device push parity Supabase/Yandex до повторного tenant dry-run.
...
- Полный check — 1246 frontend и 361 API тест; local verify — 988 SQL/RLS и 30 actor/RLS; UI не менялся, новая visual/e2e-проверка не требовалась.
