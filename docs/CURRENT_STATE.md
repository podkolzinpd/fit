...
Обновлено: 2026-09-03. База задачи: `main` `40dacc2` (#776, read-only Terraform plan push bootstrap). Активная задача: каталог, новые названия и синонимы, PR #777; см. `docs/design/EXERCISE_CATALOG_CURATION.md`.
