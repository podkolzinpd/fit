...
Обновлено: 2026-09-07. База: `main` `5996f3f2`. Активно: точечное восстановление Gym Pro video URL в итоговом каталоге и защита сценария первого тапа.
...
- Каталог сохраняет 663 прежних ref и добавляет 317 проверенных Gym Pro
  ...
  открывает технику, а `+ / ✓` независимо меняет выбор.
