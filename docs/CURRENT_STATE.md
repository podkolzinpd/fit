...
Обновлено: 2026-09-18. Проверенный `main`: `cd4babab` (#1029). Frontend
...
- #1027 восстановил явный ввод кодов приглашения; #1028 оставил готовые
  тренировки постоянно доступными; #1029 разрешил активному клиенту менять
  профиль через эквивалентные Supabase/Yandex mutations.
