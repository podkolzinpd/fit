...
Обновлено: 2026-09-09. База: `main` `a53bc6d2` (#826). Активно: YAFIT-488 — юридические документы и безопасный переход регистрации с Google. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
