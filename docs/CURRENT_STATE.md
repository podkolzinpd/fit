...
- В пустой истории тренировок клиент и тренер видят нейтральный стартовый блок
  с коротким объяснением и одним действием. Дублирующие действия и тяжёлая
  коралловая заливка не используются.
