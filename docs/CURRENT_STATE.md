...
Обновлено: 2026-09-03. База задачи: `main` `2b8cf62` (#773). Активная задача: согласованный каталог, новые названия и сохранение синонимов; см. `docs/design/EXERCISE_CATALOG_CURATION.md`.
...
- ФИТ 7: полный check, 1104 frontend / 306 API / 911 SQL/RLS, чистый reset и сверка generated types прошли. Ручная браузерная приёмка заблокирована политикой runtime; production не изменён.
## Ближайший порядок
