...
Проверенный `main`: `d4278b7` (`YAFIT-304: исправлена мобильная разметка полей бега (#403)`)

## Активная работа

- Активной задачи нет. Следующая задача согласованного бегового блока:
  `YAFIT-301` — интервалы, восстановление и СБУ; не начинать без команды пользователя.
