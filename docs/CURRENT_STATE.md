...
Обновлено: 2026-09-10. База ветки: `main` `addb8fc3` (#857). YAFIT-496 выпущена: последний подтверждённый фактический вес переносится в следующие нетронутые подходы той же плановой группы; каталог тренеров из #857 сохранён. Активно: YAFIT-497 связывает обещание об отзыве и вопрос тренеру только с текущим активным membership. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
...
- Каталог сохраняет 663 прежних ref и добавляет 317 проверенных Gym Pro
  ...
  показывают медиа только при наличии точной Vital-анимации; совместимые
  ...
  блокируются на уровне компонента. Непокрытое упражнение остаётся текстовым;
