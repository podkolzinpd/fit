...
Обновлено: 2026-09-10. База ветки: `main` `79022e92` (#855). Активно: YAFIT-496 переносит последний подтверждённый фактический вес в следующие нетронутые подходы той же плановой группы; ИИ-анализ целого периода из #855 сохранён. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
