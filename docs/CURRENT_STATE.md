...
Обновлено: 2026-09-09. База: `main` `178094d`. Активно: YAFIT-480–483, автономно утверждены все четыре этапа Home/Progress.
...
- YAFIT-480 закрыт: #827 + #828 / 178094d, CI/Vercel/DB и повторный Yandex 34285336984 зелёные, свежий iOS запущен. YAFIT-481: компактная карта Home и точный переход к раскрываемой карте Progress реализованы; идут проверки.
...
## Ближайший порядок
1. Завершить обычный merge/deploy YAFIT-481 после проверок.
2. Выполнить и выпустить YAFIT-482: композиция Progress, свежие факты и доступ к ИИ.
