...
Обновлено: 2026-09-09. База: `main` `d10c965`. Активно: YAFIT-485, упрощение текстов результата и карты тела на Client Home. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
...
- YAFIT-485 локально: полный check 1305/364/112, 90 целевых component-тестов
...
## Ближайший порядок
1. YAFIT-480–484 выпущены. YAFIT-485 сокращает тексты личного результата и компактной карты на Home.
2. В карточке остаются результат, короткое сравнение, действия, общее число подходов и зоны; повтор выбранной зоны и пояснение про рост/восстановление удаляются.
3. Расчёты, маршруты, карта тела и ИИ-контур не меняются.
4. Далее: CI, штатный merge, production и свежая мобильная сборка из подтверждённого `main`.
