...
Обновлено: 2026-09-10. База ветки: `main` `74b89775` (#845). Активно: стабильная композиция Client Progress и верхнее превью ИИ. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
