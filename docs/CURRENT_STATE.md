...
Обновлено: 2026-09-03. Проверенный базовый `main`: `f5bdd44` (#772). Активная задача: ФИТ 7 — отключение конкретного приглашённого тренера; см. `docs/design/FIT7_TRAINER_DISCONNECT.md`.
