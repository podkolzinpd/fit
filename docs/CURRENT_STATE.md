...
Обновлено: 2026-09-10. База ветки: `main` `2e8fd955` (#858). YAFIT-496 и YAFIT-497 выпущены: фактический вес переносится в следующие нетронутые подходы той же плановой группы, а обещание об отзыве и вопрос тренеру показываются только при текущем активном membership. Активно: YAFIT-498 отделяет точное медиа узкой тяги верхнего блока от ролика широкого хвата. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
