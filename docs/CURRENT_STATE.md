...
Проверенный `main`: `e265506` (`YAFIT-296: считать частичные тренировки и объяснить рекорд (#395)`)

## Активная работа

- Активна служебная `YAFIT-297`: UI/UX engineering rails, правила и визуальные
  профили без изменения интерфейса и бизнес-логики.
