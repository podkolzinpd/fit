...
Проверенный базовый `main`: `48811b6` (`YAFIT-322: унифицировать Progress тренера и клиента (#479)`)
...
- Отдельная серия улучшений Progress идёт по согласованному плану. `#474`
  ...
  для тренера и клиента. YAFIT-323 собирает замеры в один компактный блок:
  последнее значение и динамика видны сразу, а добавление, история и настройка
  показателей раскрываются отдельно без вложенных карточек. Полный план сохранён в
