...
Обновлено: 2026-09-08. База: `main` `7c362e20`. Активно: довести автоматический remote tenant dry-run до чистого cohort без ручного UUID.
...
- Полный check — 1246 frontend и 364 API теста; две локальные репетиции — 36 строк в 28 таблицах; UI не менялся.
