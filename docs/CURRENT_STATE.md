...
Обновлено: 2026-09-09. База: `main` `772ddaf6` (#840). Активно: содержательный ИИ-анализ Progress. Постоянное разрешение на автономный выпуск зафиксировано в `AGENTS.md`.
