...
| Schedule | Week/month/local date, timed/untimed, open workout/back | Implemented: week/month navigation with URL state, «Сегодня», per-period load covered unit + E2E; timed/untimed ordering pending |
