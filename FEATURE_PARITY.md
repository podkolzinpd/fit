...
- Picker даёт быстрый фильтр «Бег и СБУ» и четыре базовых СБУ с вводом времени и
  дистанции. Обязательная проверка: Trainer создаёт план, Client последовательно
  подтверждает отрезки в WebKit 390 px, обе роли видят ту же структуру.
