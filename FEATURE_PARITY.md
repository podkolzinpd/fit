...
тренер test@test.com, цель и сохраняемый квиз, подтверждённая история клиента,
private CF, упражнения из каталога и детерминированные назначения на 4 недели
