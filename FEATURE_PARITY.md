...
| Profile | Просмотр и изменение имени, корректный Cancel, выбор темы | Implemented: edit/logout ready; Cancel всегда возвращает клиента в профиль без сохранения черновика, covered iPhone WebKit 390 px; переключатель «Тёмная тема» отдаёт allowlisted-аккаунтам пилотную палитру из Figma — тёмную или светлую по своему списку, — остальным прежние темы |
